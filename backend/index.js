...
app.post('/createBook', async (req, res) => {
  ...
  // 2. Scenes 1–15: generate, crop left/right, crop each to square, upload (pages 02–31)
  for (let i = 1; i <= 15; i++) {
  ...
  // 3. Generate and upload back cover (scene 16 → page 32) — crop to square, optional logo
